...
Profile.create!(age: 24, height: "5'7\"", short_bio: "I would like to find my partner in crime to tear up the city", interests: "Coffee, Hiking, Instagram, Movies, Fast Cars", user_id: 1, first_quality: "Best cook in the world!", second_quaity: "Super organized with everything", third_quality: "Always on time")
...
user1.send_message(user2, "You are a cool guy", "Hi :)")
user2.send_message(user2, "Whats up dude!", "Yolo")
user3.send_message(user2, "What are you up to?", "Are you that guy?")
user4.send_message(user2, "Why are the birds at the zoo?", "What is up?")
